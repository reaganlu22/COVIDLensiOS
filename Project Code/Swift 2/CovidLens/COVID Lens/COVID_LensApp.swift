...
class AppDelegate: NSObject, UIApplicationDelegate, GIDSignInDelegate, ObservableObject{
    ...
    var apiKey = "AIzaSyCTl2xQAqZJSlV3aaHqQ-4-uZkjhjGIRU0" // your api key here
    ...
    func application(_ application: UIApplication,
        ...
        UITabBar.appearance().barTintColor = UIColor(Color(red: 240/255, green: 240/255, blue: 240/255))
         ...
         GIDSignIn.sharedInstance().clientID = "609638446104-ltsnv0sseo0gt6pdcrmlharlq7kiv8g4.apps.googleusercontent.com" // your google client id here
