...
final class ResourcesVM: ObservableObject {
    let links = [
        ...
        LinkViewModel(name: "Centers for Disease Control and Prevention (CDC)", url: URL("https://www.cdc.gov/coronavirus/2019-nCoV/index.html")),
        LinkViewModel(name: "World Health Organization (WHO)", url: URL("https://www.who.int/emergencies/diseases/novel-coronavirus-2019"))
    ]
